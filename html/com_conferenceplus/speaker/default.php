...
<div class="conferenceplus item speaker item-page">
	<div class="page-header">
		<h<?php echo $headerlevel; ?>><?php echo $title; ?></h<?php echo $headerlevel; ?>>
	</div>

		<div class="row clearfix speakerprofile speakerdescription">
			<div class="col-md-4">
				<?php if ($showImg) : ?>
	...
	<?php if ( ! empty($item->assignedSessions)) : ?>
		<h<?php echo $shl111; ?>><?php echo JText::_('COM_CONFERENCEPLUS_SPEAKERS_SESSIONS'); ?></h<?php echo $shl1; ?>>
